...
def main():
    ...
    pcd = generate_sample_pointcloud("/home/intel/fiverr/md/ws/src/UAV_UGV/sjtu_drone_bringup/map/garden.pcd")
    ...
    goal_point = np.array([10.0,-4.3, 1.0])   # Replace with actual goal point
